...
def run_test_zero_changer():
    ...
    # ------------------------------------------------------------------
    # TO DO: 2. Write at least 2 additional tests for the  zero_changer   function.
    #   Try do do some unexpected things like empty lists or an empty tuple.
    # ------------------------------------------------------------------

    test2 = ([8, 9], [], [4, 0, 0, 4],[2, 4, 3, 1, 0, 0, 4])
    expected2 = ([8, 9], [], [4, 1, 2, 4], [2, 4, 3, 1, 3, 4, 4])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    test3 = ([2, 6, 1, 5], [2, 5, 0, 0, 1, 5, 3, 4], [1, 4, 0, 3])
    expected3 = ([2, 6, 1, 5], [2, 5, 1, 2, 1, 5, 3, 4], [1, 4, 3, 3])
    zero_changer(test3)
    print()
    print('Test 3:')
